...
class UI:
    def __init__(self, surface):
        ...
        self.health_bar = pygame.image.load(
            '..//game/graphics/ui/health_bar.png').convert_alpha()
        ...
        self.coin = pygame.image.load(
            '..//game/graphics/ui/coin.png').convert_alpha()
        self.coin_rect = self.coin.get_rect(topleft=(50, 61))
        self.font = pygame.font.Font(
            '..//game/graphics/ui/ARCADEPI.TTF', 30)
    ...
    def show_coins(self, amount):
        ...
        coin_amount_rect = coin_amount_surf.get_rect(
            midleft=(self.coin_rect.right+6, self.coin_rect.centery))
