...
class Player(pygame.sprite.Sprite):
    ...
    def import_dust_run_particles(self):
        self.dust_run_particles = import_folder(
            '..//game/graphics/character/dust_particles/run')
    ...
    def run_dust_animation(self):
        ...
        dust_particle = self.dust_run_particles[int(self.frame_index)]
        ...
        if self.status == 'run' and self.on_ground:
            ...
            if self.facing_right:
                dest = self.rect.bottomleft - pygame.math.Vector2(6, 10)
                self.display_surface.blit(dust_particle, dest)

            if self.facing_left:
                dest = self.rect.bottomright - pygame.math.Vector2(6, 10)
                flipped_dust_particle = pygame.transform.flip(
                    dust_particle, True, False)
                self.display_surface.blit(flipped_dust_particle, dest)
